...
namespace Kyrsach
{
    public partial class Test_Form_Name_diff : Form
    {
        FileEditor csv;
        Thread next_form;
        public Test_Form_Name_diff()
        {
        ...
        {
            Application.Run(new Test_diff_color());
        }

        private void Test_Form_Name_diff_Load(object sender, EventArgs e)
        {
